...
public class DnDTabbedPane extends JTabbedPane {
    ...
    public DnDTabbedPane() {
        super();
        setUI(new HideableTabbedPaneUI());
  ...
  //======================================================================
  //======================================================================
    private class HideableTabbedPaneUI extends BasicTabbedPaneUI {
        ...
        @Override
        protected int calculateTabAreaWidth(int tabPlacement, int horizRunCount, int maxTabHeight) {
            if (showTabsHeader) {
                return super.calculateTabAreaWidth(tabPlacement, horizRunCount, maxTabHeight);
            }
            return 0;
        }
    ...
    public static void main(String[] args) {
    	//demoSplitPaneTwoTabs();
    	demoJTabbedPaneTabs();
    }
    
    private static void demoJTabbedPaneTabs() {
        JFrame test = new JFrame("Tab test");
        test.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        test.setSize(400, 400);
        
        DnDTabbedPane leftTabs = new DnDTabbedPane();
        leftTabs.setTabPlacement(SwingConstants.TOP);
        leftTabs.setTabLayoutPolicy(JTabbedPane.SCROLL_TAB_LAYOUT);
        
        JButton l1 = new JButton("L - One");
        ...
        leftTabs.addTab("L - One", l1);
        leftTabs.addTab("L - Two", new JButton("L - Two"));
        leftTabs.addTab("L - Three", new JButton("L - Three"));
        leftTabs.addTab("L - Four", new JButton("L - Four"));

        
//        leftTabs.setUI(new javax.swing.plaf.metal.MetalTabbedPaneUI() {
...
//          });
    ...
    private static void demoSplitPaneTwoTabs() {
        JFrame test = new JFrame("Tab test");
        test.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        test.setSize(400, 400);
        
        DnDTabbedPane leftTabs = new DnDTabbedPane();
        leftTabs.addTab("L - One", new JButton("L - One"));
        leftTabs.addTab("L - Two", new JButton("L - Two"));
        leftTabs.addTab("L - Three", new JButton("L - Three"));
        leftTabs.addTab("L - Four", new JButton("L - Four"));

        DnDTabbedPane rightTabs = new DnDTabbedPane();
        rightTabs.addTab("R - One", new JButton("R - One"));
        rightTabs.addTab("R - Two", new JButton("R - Two"));
        rightTabs.addTab("R - Three", new JButton("R - Three"));
        rightTabs.addTab("R - Four", new JButton("R - Four"));
        
        JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, leftTabs, rightTabs);
        test.add(splitPane);
        test.setVisible(true);
    }
    
	public static void setLookAndFeel(final String lafName) {
		try {
		    ...
		    // If LookAndFeel is not available, you can set the GUI to another look and feel.
			try{
				UIManager.setLookAndFeel(UIManager.getCrossPlatformLookAndFeelClassName());
			}catch(final Exception uex){
